document.addEventListener("DOMContentLoaded", function () {
    ...
    infoTexto.innerHTML = "Agora é a vez das peças: <span style='color: red;'>Vermelhas</span>";
        ...
        if (pecaSelecionada.classList.contains(`${jogadorAtual}-peca`)) {
            ...
            jogadorAtual = jogadorAtual === "red" ? "black" : "red";
                if(jogadorAtual  === "red"){
                    ...
                    infoTexto.innerHTML = "Agora é a vez das peças: <span style= 'color: dodgerblue; '>Azuis</span>";
    ...
    function gameOver(){
        ...
        if(jogadorVermelho == 0){
            ...
            tituloModal.innerHTML = "As peças azuis venceram!"
        }else if(jogadorPreto == 0){
            modalWin.style.display = "block";
            tituloModal.innerHTML = "As peças vermelhas venceram!"
